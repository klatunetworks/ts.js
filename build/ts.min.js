...
domain  : ${this.domain()}
range   : ${this.range()}
variance: ${this.variance()}`}};p=class extends o{constructor(t){var e,s,i,r,h,n,a,l;for(super(t),this.lookup={},this.attrs=[],h=this.data,e=0,i=h.length;e<i;e++){r=h[e],n=r[1];for(s in n)l=n[s],this.lookup.hasOwnProperty(s)||(this.lookup[s]=[],this.attrs.push(s)),this.lookup[s].push([r[0],l])}a=this.lookup;for(s in a)l=a[s],this.lookup[s]=f.build(this.lookup[s])}series(t){var e,s;return t[0]==="/"?this.series(t.substr(1)):t.indexOf("/")>0?(s=t.split("/"),e=s.shift(),this.lookup[e]?this.lookup[e].series(s.join("/")):null):this.lookup[t]?this.lookup[t]:null}get(t){return this.series(t)}limit(t){var e,s,i,r;super.limit(t),s=this.lookup,i=[];for(e in s)r=s[e],i.push(r.limit(t));return i}append(t,e){var s,i;for(s in e)i=e[s],this.lookup.hasOwnProperty(s)?this.lookup[s].append(t,i):(this.lookup[s]=f.build([[t,i]]),this.attrs.push(s));return super.append(t,e)}attr(t){return this.series(t)}serieses(){return this.attrs}min(){var t,e,s,i;e=[],s=this.lookup;for(t in s)i=s[t],i.min&&e.push(i.min());return Math.min.apply(Math,e)}max(){var t,e,s,i;e=[],s=this.lookup;for(t in s)i=s[t],i.max&&e.push(i.max());return Math.max.apply(Math,e)}exists(t){return this.series(t)!==null}};var k=f;return _(y);})();
